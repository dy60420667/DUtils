...
public class HomeFragment extends Fragment {
    ...
    private void initViewPager() {
        ...
        for (int i = 0; i < tips.length; i++) {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(DevicesUtils.dp2px(getActivity(), 8), DevicesUtils.dp2px(getActivity(), 8));
            params.setMargins(DevicesUtils.dp2px(getActivity(), 5), DevicesUtils.dp2px(getActivity(), 11), DevicesUtils.dp2px(getActivity(), 5), DevicesUtils.dp2px(getActivity(), 11));
