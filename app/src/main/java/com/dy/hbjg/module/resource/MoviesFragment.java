...
public class MoviesFragment extends DYBaseFragment implements ViewPager.OnPageChangeListener {
    public static MoviesFragment createFragment(){
        MoviesFragment f_movies_top =new MoviesFragment();
        return f_movies_top;
    }
    ...
    private class MainAdapter extends FragmentPagerAdapter {
        ...
        public MainAdapter(FragmentManager fm) {
            super(fm);
            list = new ArrayList<>();
            list.add(MoviestopFragment.createFragment());
            list.add(MoviesInTheatersFragment.createFragment());
        }
