package dy.utils.libhttp.downloadservice.db;
...
public class DownloadDBManager {
    ...
    public void delete(String downloadurl) {
        try{
            db.delete(DBOpenHelper.TABLE_NAME_DOWNLOADITEM,"downloadurl = ? ", new String[]{downloadurl});
        }catch (Exception e){
...
//        Log.i("xx","sql:"+sql);
    ...
    public DownloadBean getDownloadTask(String downloadurl) {
        ...
        Cursor cur = null;
        try {
             cur = db.rawQuery("select * from " + DBOpenHelper.TABLE_NAME_DOWNLOADITEM + " where downloadurl = "+downloadurl, null);
